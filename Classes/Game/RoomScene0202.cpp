...
{
	auto item_1 = MenuItemImage::create("game1/object/back.png", "game1/object/back_on.png", CC_CALLBACK_1(RoomScene0202::callObj1Content, this));
...
//	int saved = UserDefault::getInstance()->getIntegerForKey("LASTPLAYED");
	...
	auto sprite1 = Sprite::create("game1/bg2-1.png");
...
{
	auto item_1 = MenuItemImage::create("game1/object/room0202_0.png", "game1/object/room0202_0_on.png", CC_CALLBACK_1(RoomScene0202::callObj2Content, this));
	if(UserDefault::getInstance()->getIntegerForKey("item_room0202_0") == 1)
	{
		item_1 = MenuItemImage::create("game1/object/room0202_0.png", "game1/object/room0202_0.png", CC_CALLBACK_1(RoomScene0202::nothing, this));
	}
