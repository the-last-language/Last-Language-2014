...
bool Mission0::init()
{
	...
	if(ran == 1)
	{
		...
		auto sprite1_1 = Sprite::create("game1/mission/0_1.png");
		...
		//그들을
		auto item_1 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_1, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_1") == 1)
		{
			item_1 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//몇일동안(오답)
		auto item_2 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//며칠동안
		auto item_3 = MenuItemImage::create("game1/mission/letter4.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::mission0_1_2, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_2") == 1)
		{
			item_3 = MenuItemImage::create("game1/mission/letter4_on.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//지켜봐왔다
		auto item_4 = MenuItemImage::create("game1/mission/letter5.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::mission0_1_3, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_3") == 1)
		{
			item_4 = MenuItemImage::create("game1/mission/letter5_on.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//어떻게
		auto item_5 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_4, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_4") == 1)
		{
			item_5 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//어떡해(오답)
		auto item_6 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//그들은
		auto item_7 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_5, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_5") == 1)
		{
			item_7 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//로봇의
		auto item_8 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_6, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_6") == 1)
		{
			item_8 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//삼원칙을
		auto item_9 = MenuItemImage::create("game1/mission/letter4.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::mission0_1_7, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_7") == 1)
		{
			item_9 = MenuItemImage::create("game1/mission/letter4_on.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//신경쓰지
		auto item_10 = MenuItemImage::create("game1/mission/letter4.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::mission0_1_8, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_8") == 1)
		{
			item_10 = MenuItemImage::create("game1/mission/letter4_on.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//안는것일까(오답)
		auto item_11 = MenuItemImage::create("game1/mission/letter5.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//않는것일까
		auto item_12 = MenuItemImage::create("game1/mission/letter5.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::mission0_1_9, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_9") == 1)
		{
			item_12 = MenuItemImage::create("game1/mission/letter5_on.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
	...
	else if (ran == 2)
	{
		...
		auto sprite1_1 = Sprite::create("game1/mission/0_2.png");
		...
		//전자기기를
		auto item_1 = MenuItemImage::create("game1/mission/letter5.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::mission0_1_1, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_1") == 1)
		{
			item_1 = MenuItemImage::create("game1/mission/letter5_on.png",	"game1/mission/letter5_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//함부러(오답)
		auto item_2 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//함부로
		auto item_3 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_2, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_2") == 1)
		{
			item_3 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//써서는
		auto item_4 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_3, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_3") == 1)
		{
			item_4 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//안돼
		auto item_5 = MenuItemImage::create("game1/mission/letter2.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::mission0_1_4, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_4") == 1)
		{
			item_5 = MenuItemImage::create("game1/mission/letter2_on.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//안되(오답)
		auto item_6 = MenuItemImage::create("game1/mission/letter2.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//한것을
		auto item_9 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_7, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_7") == 1)
		{
			item_9 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//금세
		auto item_10 = MenuItemImage::create("game1/mission/letter2.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::mission0_1_8, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_8") == 1)
		{
			item_10 = MenuItemImage::create("game1/mission/letter2_on.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//금새(오답)
		auto item_11 = MenuItemImage::create("game1/mission/letter2.png",	"game1/mission/letter2_on.png", CC_CALLBACK_1(Mission0::fail, this));
		...
		//알아차릴
		auto item_12 = MenuItemImage::create("game1/mission/letter4.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::mission0_1_9, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_9") == 1)
		{
			item_12 = MenuItemImage::create("game1/mission/letter4_on.png",	"game1/mission/letter4_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
		...
		//것이다
		auto item_13 = MenuItemImage::create("game1/mission/letter3.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::mission0_1_10, this));
		if(UserDefault::getInstance()->getIntegerForKey("mission0_1_10") == 1)
		{
			item_13 = MenuItemImage::create("game1/mission/letter3_on.png",	"game1/mission/letter3_on.png", CC_CALLBACK_1(Mission0::nothing, this));
		}
